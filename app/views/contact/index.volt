...
<p>
    Send us a message and let us know how we can help. Please be as descriptive
    as possible as it will help us serve you better.
</p>
...
?>
    <fieldset>
        ...
        <div class='control-group'>
            ...
            <div class='controls'>
                <?php echo Tag::textArea(array('comments', 'rows' => '5', 'class' => 'input-xlarge')) ?>
                <p class='help-block'>(required)</p>
            </div>
        </div>
